...
return (
    <div className=' w-[85%] max-w-[400px] sm:w-full h-full flex flex-row items-center justify-center'>
        <div className='w-[10%] sm:w-[20%] h-[3rem] flex items-center justify-center '>
            <div className='py-1 h-[2.2rem] w-full flex items-center justify-center bg-blue-200 rounded-l-2xl'>
        ...
        className='w-[90%] sm:w-[80%] h-full flex items-center justify-center'>
            ...
            name = {'search'}
            placeholder = "Search"
            className='w-full h-[2.2rem] bg-blue-200 text-[0.9rem] text-[#0b3c52] kanit rounded-r-2xl focus:outline-none'

...
function Navbar ({ postCreation, setPostCreation }) {
	...
	return (
		<nav className='w-full h-[70px] fixed bg-[#f7f7f7] dark:bg-[#232323] flex flex-row items-center justify-between z-50'>
...

			{
				...
				<div className=' hidden lg:flex flex-row items-center gap-16'>
					...
					<div className='w-[1.6rem] h-[1.6rem] flex items-center justify-center '>
						<svg className='w-[1.3rem] h-[1.3rem] -mt-[1px]' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11 6C13.7614 6 16 8.23858 16 11M16.6588 16.6549L21 21M19 11C19 15.4183 15.4183 19 11 19C6.58172 19 3 15.4183 3 11C3 6.58172 6.58172 3 11 3C15.4183 3 19 6.58172 19 11Z" stroke={active2 ? "#ffffff" : "#232323" } stroke-width="1.744" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
					</div>
					</NavLink>
					...
					<div className='w-[1.6rem] h-[1.6rem] flex items-center justify-center'>
						<svg className='w-[1.2rem] h-[1.2rem]' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12.02 2.90991C8.70997 2.90991 6.01997 5.59991 6.01997 8.90991V11.7999C6.01997 12.4099 5.75997 13.3399 5.44997 13.8599L4.29997 15.7699C3.58997 16.9499 4.07997 18.2599 5.37997 18.6999C9.68997 20.1399 14.34 20.1399 18.65 18.6999C19.86 18.2999 20.39 16.8699 19.73 15.7699L18.58 13.8599C18.28 13.3399 18.02 12.4099 18.02 11.7999V8.90991C18.02 5.60991 15.32 2.90991 12.02 2.90991Z" stroke={active3 ? "#ffffff" : "#232323" } stroke-width="1.64" stroke-miterlimit="10" stroke-linecap="round"></path> <path d="M13.87 3.19994C13.56 3.10994 13.24 3.03994 12.91 2.99994C11.95 2.87994 11.03 2.94994 10.17 3.19994C10.46 2.45994 11.18 1.93994 12.02 1.93994C12.86 1.93994 13.58 2.45994 13.87 3.19994Z" stroke={active3 ? "#ffffff" : "#232323" } stroke-width="1.44" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M15.02 19.0601C15.02 20.7101 13.67 22.0601 12.02 22.0601C11.2 22.0601 10.44 21.7201 9.90002 21.1801C9.36002 20.6401 9.02002 19.8801 9.02002 19.0601" stroke={active3 ? "#ffffff" : "#232323" } stroke-width="1.44" stroke-miterlimit="10"></path> </g></svg>
					</div>
					</NavLink>
...

			{
				...
				<div className='flex flex-row gap-6 mx-4 dosis text-lg font-semibold items-center relative'>
					...
					<div className={`${postCreation ? 'bg-blue-100' : 'bg-white hover:bg-[#eeeeee]'} duration-300 ease-in-out w-[2rem] h-[2rem] cursor-pointer rounded-xl flex items-center justify-center`}
					style={{
					...
					onClick={() => {
						...
						<svg className='w-[1.5rem] h-[1.5rem]' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 4C12.5523 4 13 4.44772 13 5V11H19C19.5523 11 20 11.4477 20 12C20 12.5523 19.5523 13 19 13H13V19C13 19.5523 12.5523 20 12 20C11.4477 20 11 19.5523 11 19V13H5C4.44772 13 4 12.5523 4 12C4 11.4477 4.44772 11 5 11H11V5C11 4.44772 11.4477 4 12 4Z" fill={postCreation ? '#2292ce' : '#232323'}></path> </g></svg>
					</div>

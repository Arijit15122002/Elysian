...
function Navbar () {
	...
	return (
		<nav className='w-full h-[70px] fixed bg-white dark:bg-[#232323] flex flex-row items-center justify-between z-50'>
			...
			<Link className='flex flex-row h-full items-center gap-4 mx-4'>
				<svg width="60px" height="60px" viewBox="-8.96 -8.96 81.92 81.92" xmlns="http://www.w3.org/2000/svg" fill="none" stroke={theme === 'dark' ? '#232323' : '#ffffff'} stroke-width="3.4560000000000004">
				...
				<div className='text-5xl flex text-[#232323] grand items-end'>

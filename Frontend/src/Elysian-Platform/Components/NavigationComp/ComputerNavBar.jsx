			...
			<nav className='w-full h-[70px] fixed bg-[#f7f7f7] dark:bg-[#111111] flex flex-row items-center justify-between z-50'>
...

				{
					...
					<div className='flex flex-row gap-6 mx-4 dosis text-lg font-semibold items-center relative'>
						...
						<div className={`${postCreation ? 'bg-[#c1ff31] dark:bg-[#111111]' : 'bg-white hover:bg-[#eeeeee] dark:bg-[#c1ff31] dark:hover:opacity-80 dark:hover:shadow-[0_0_7px_0_rgba(0,0,0,0.2)]'} duration-300 ease-in-out w-[2rem] h-[2rem] cursor-pointer rounded-xl flex items-center justify-center shadow-[0_0_7px_0_rgba(0,0,0,0.2)] dark:shadow-none`}
						onClick={() => {

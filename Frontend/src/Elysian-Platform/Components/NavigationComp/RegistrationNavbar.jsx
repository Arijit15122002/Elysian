...
function RegistrationNavbar () {
    ...
    <>
        <nav 
			className='w-full h-[70px] fixed bg-[#f7f7f7] dark:bg-[#111111] flex flex-row items-center justify-between z-50'
		>
            <Link to={'/'} className='flex flex-row h-full items-center gap-2 mx-4'>
				<svg width="45px" height="45px" viewBox="-8.96 -8.96 81.92 81.92" xmlns="http://www.w3.org/2000/svg" fill="none" stroke={theme === 'dark' ? '#232323' : '#f7f7f7'} stroke-width="3.4560000000000004">
				...
				<div className='text-[2rem] flex text-[#232323] dark:text-white grand items-end'>
            ...
            <div className='flex flex-row gap-4 mx-4 dosis text-lg font-semibold items-center relative'>
                <div className=' hidden sm:flex flex-row gap-16 mx-16 dosis text-lg font-semibold'>
					<NavLink to={'/signup'} className={({isActive}) => `${isActive ? 'bg-[#111111] dark:bg-white text-white dark:text-black shadow-md shadow-black/50' : 'dark:text-white'} hover:bg-[#040404] hover:text-white hover:shadow-md hover:shadow-black/50 px-4 py-2 rounded-2xl duration-300 ease-in-out`}>
						REGISTER
					</NavLink>

					<NavLink to={'/login'} className={({isActive}) => `${isActive ? 'bg-[#111111] dark:bg-white text-white dark:text-black shadow-md shadow-black/50' : 'dark:text-white'} hover:bg-[#040404] hover:text-white hover:shadow-md hover:shadow-black/50 px-4 py-2 rounded-2xl duration-300 ease-in-out`}>
						LOGIN
					</NavLink>
				</div> 
            </div>

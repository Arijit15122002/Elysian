...
function ComputerSideNavigation () {
    ...
    return (
    <>
        <div className='flex flex-col parent-div py-6 h-auto rounded-lg border-[3px] border-[#dddddd] gap-6 px-2 bg-white/50 backdrop-blur-md'>
        
            <NavLink to={"/feed"} className={({isActive}) => {
                isActive ? setActive1(true) : setActive1(false)
                return `${isActive ? 'bg-blue-100 text-blue-600' : 'hover:bg-[#eeeeee] text-[#232323]'} px-2 py-3 rounded-2xl w-full flex flex-row items-center duration-300 ease-in-out`
            }}>
                <div className='w-[1.6rem] h-[1.6rem] -ml-[5px]'>
                    <svg className='w-[2rem] h-[2rem] -mt-[4px]' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="1.2"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M9 20H7C5.89543 20 5 19.1046 5 18V10.9199C5 10.336 5.25513 9.78132 5.69842 9.40136L10.6984 5.11564C11.4474 4.47366 12.5526 4.47366 13.3016 5.11564L18.3016 9.40136C18.7449 9.78132 19 10.336 19 10.9199V18C19 19.1046 18.1046 20 17 20H15M9 20V14C9 13.4477 9.44772 13 10 13H14C14.5523 13 15 13.4477 15 14V20M9 20H15" stroke={active1 ? "#056ed7" : "#232323" } stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
                </div>
                <div className='text-div dosis font-bold pl-[12px]'>
                    HOME
                </div>
            ...
            <NavLink to={"/search"} className={({isActive}) => {
                ...
                return `${isActive ? 'bg-blue-100 text-blue-600' : 'hover:bg-[#eeeeee] text-[#232323]'} px-2 py-3 rounded-2xl w-full flex flex-row items-center duration-200 ease-in-out`
            }}>
                ...
                <div className='text-div dosis font-bold pl-[8px]'>
                    SEARCH
                </div>
            </NavLink>
            ...
            <NavLink to={"/notifications"} className={({isActive}) => {
                ...
                <div className='w-[1.6rem] h-[1.6rem] -ml-[2px]'>
                ...
                <div className='text-div dosis font-bold pl-[9px]'>
                    NOTIFICATIONS
                </div>
            </NavLink>

  ...
  return (
    <>
        <div className='w-[90%] max-w-[580px] mx-auto h-auto flex justify-center mb-6'>
            <div className='w-full h-auto rounded-2xl border-[2px] border-[#cccccc] overflow-hidden relative pb-[30px]'>
                <div className='flex flex-row px-6 py-4 items-center justify-between'>
                    <div className='flex flex-row items-center'>
                        ...
                        <div className='flex flex-col px-4'>
                            <div className={`${ deviceType === 'mobile' ? 'flex-col' : 'flex-row items-center' } flex`}>
                                <Link className={`${ deviceType === 'mobile' ? 'text-[0.9rem]' : 'text-[1.1rem]' } radio text-[#555555] font-semibold hover:underline cursor-pointer `}>
                                    {post.user.fullname}
                                </Link>
                                {
                                    post.checkIn ? <div>
                                        <div className={`${ deviceType === 'mobile' ? 'text-[0.7rem]' : 'text-[1.1rem]' } text-[#555555] kanit`}>
                                        {
                                            deviceType === 'mobile' ? 
                                            <div>
                                            at {post.checkIn}
                    ...
                    <div className='p-2 bg-[#efefef] hover:bg-[#dddddd] rounded-full cursor-pointer duration-200 ease-in-out'>
                ...
                <div className='w-full h-auto hidden sm:flex flex-row gap-4 justify-center pb-6 absolute bottom-0'>
                    <div 
                        onClick={handleLike} 

...
function PostCard ({ post }) {
  ...
  return (
    <>
        <div className='w-[90%] max-w-[620px] mx-auto h-auto flex justify-center mb-6'>
            <div className='w-full h-auto rounded-2xl border-[2px] border-[#eeeeee] dark:border-[#232323] bg-white dark:bg-[#232323] shadow-[0_0_10px_0_rgba(0,0,0,0.1)] overflow-hidden relative pb-[30px]'>
                <div className='flex flex-row px-6 py-4 items-center justify-between'>
                    ...
                    <div className='p-2 bg-[#232323] dark:bg-white rounded-full cursor-pointer duration-200 ease-in-out shadow-md shadow-[#232323]/50 dark:shadow-black '>
...

                {
                    ...
                    <div className='text-semibold text-[#111111] dark:text-white kanit px-12 pt-1 pb-3 text-[0.9rem]'>
                        {post.text}
                    </div> : <div className='w-[80%] mx-auto text-semibold text-[#262525] dark:text-white kanit px-6 pt-3 pb-6 text-[1.1rem] bg-[#f7f7f7] dark:bg-[#111111] rounded-xl'>
                        {post.text}
                    </div>
                }
                ...
                <div className='w-[80%] mx-auto h-auto flex flex-row justify-between items-center bg-[#f7f7f7] dark:bg-[#434343] my-2 rounded-xl opacity-60 dark:opacity-90'>
                    ...
                    <div className='flex flex-row items-center gap-1 px-4 py-1.5'>
                        <div className='text-[0.8rem] kanit dark:text-white'>{commentCount > 0 ? commentCount : 'Yet No Comments'}</div>
                ...
                <div className='w-full h-auto hidden sm:flex flex-row gap-4 justify-center pb-6 pt-4'>
                    <div 
                        ...
                        <div className={`${ likedPost ? 'text-blue-600' : 'text-black dark:text-white' } text-[0.9rem] kanit`}>Like</div>
                    </div>
                    ...
                    >
                        ...
                        <div className='text-black dark:text-white text-[0.9rem] kanit'>Comment</div>
                    </div>

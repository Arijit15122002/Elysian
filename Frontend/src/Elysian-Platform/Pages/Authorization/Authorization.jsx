...
function Authorization ({type}) {
	...
	return (
	<div className='w-[100vw] h-auto flex justify-center items-end '>

		{/* MOBILE VIEW */}
		<div className='w-full mt-[70px] h-auto flex flex-col items-center justify-end'>
			<form action="" className={`backdrop-blur-sm w-full bg-[#ffffff] flex flex-col items-center justify-center ${animateForm ? 'formShow' : 'formHidden'}`}>

				<div className='w-full h-auto px-6 flex flex-col gap-8 items-center justify-center mt-10'>

					<div className='w-full h-auto px-6 text-3xl belanosima text-black'>
						{
				...
				className=' mt-20 mb-10 dosis font-bold text-[1.3rem] bg-green-300 px-8 py-3 rounded-lg shadow-md shadow-black hover:scale-110 duration-300 ease-in-out cursor-pointer'>
                    {
				...
				<div className='w-full flex items-center justify-center'>
					{
						...
						<div className='text-lg text-black flex flex-row py-5 items-center font-bold'>
							...
							<Link to={'/login'} className=' mx-2 px-6 py-2  bg-blue-300 rounded-lg belanosima shadow-md shadow-black/80 font-normal hover:scale-110 duration-300 ease-in-out cursor-pointer'>
								Log in
							</Link>
						</div> : 
						<div className='w-full flex flex-col items-center '>
							...
							<div className='text-lg font-bold flex flex-row py-5 items-center'>
								...
								<Link to={'/signup'} className=' mx-2 px-6 py-2 font-normal bg-purple-300 rounded-lg belanosima shadow-md shadow-black/80 hover:scale-110 duration-300 ease-in-out'>
									Sign up
								</Link>
							</div>
						</div>

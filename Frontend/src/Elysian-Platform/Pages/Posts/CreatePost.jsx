...
function CreatePost () {
	...
	<>
	{
		...
		<div className='w-full h-full flex justify-end'>
			<div className='w-full lg:w-full h-full flex flex-row items-center'>
				...
				<div className='w-[40%] xl:w-[30%] h-full hidden lg:flex flex-col items-center overflow-y-auto' id='scrollHome'>
					...
					<div className='w-[90%] max-w-[420px] h-auto px-6 py-4 my-6 bg-[#ffffff] dark:bg-[#232323] rounded-3xl border-[1px] border-[#888888] dark:border-[#232323]'>
						<div className='w-full h-auto flex flex-row justify-between items-center'>
							...
							<div className='p-1 bg-[#dddddd] dark:bg-white rounded-full'>
								<svg className='w-[20px] h-[20px]' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M5 14C6.10457 14 7 13.1046 7 12C7 10.8954 6.10457 10 5 10C3.89543 10 3 10.8954 3 12" stroke={ theme === 'dark' ? '#232323' : '#555555' } stroke-width="1.5" stroke-linecap="round"></path> <circle cx="12" cy="12" r="2" stroke={ theme === 'dark' ? '#232323' : '#555555' } stroke-width="1.5"></circle> <path d="M21 12C21 13.1046 20.1046 14 19 14C17.8954 14 17 13.1046 17 12C17 10.8954 17.8954 10 19 10" stroke={ theme === 'dark' ? '#232323' : '#555555' } stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
							</div>
						</div>
						<div className='text-[0.9rem] text-[#232323] dark:text-white px-6 pt-8 pb-1 kanit'>
							{message}
						</div>
						...
						<div className='flex flex-row gap-2 items-center justify-between w-[100%] h-auto'>
							<div className='flex flex-row w-[28%] gap-1 text-[0.8rem] justify-center items-center rounded-xl py-2.5 bg-[#eeeeee] dark:bg-[#383838] cursor-pointer hover:bg-[#ffffff] dark:hover:bg-[#454545] duration-300 ease-in-out '>
								...
								<div className='text-[#232323] dark:text-white kanit'>Like</div>
							</div>
							<div className='flex flex-row gap-1 text-[0.8rem] justify-center items-center w-[38%] rounded-xl py-2.5 bg-[#eeeeee] dark:bg-[#383838] cursor-pointer hover:bg-[#ffffff] dark:hover:bg-[#454545] duration-300 ease-in-out'>
								...
								<div className='text-[#232323] dark:text-white kanit'>Comment</div>
							</div>
							<div className='flex flex-row gap-1 text-[0.8rem] justify-center items-center w-[28%] rounded-xl py-2.5 bg-[#eeeeee] dark:bg-[#383838] cursor-pointer hover:bg-[#ffffff] dark:hover:bg-[#454545] duration-300 ease-in-out'>
								...
								<div className='text-[#232323] dark:text-white kanit'>Share</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div className='w-full max-w-[800px] mx-auto lg:w-[60%] xl:w-[45%] h-full flex flex-col items-center overflow-y-auto' id='scrollHome'>
					...
					<div className='mt-[20px] w-[85%] lg:w-[70%] h-[70px] flex flex-row gap-3 items-center'>
						...
						<div className='w-auto h-auto flex flex-col gap-1 mb-2 relative'>
							<div className='text-[1.1rem] font-semibold dark:text-[#fefefe]'>
								{user?.fullname}
							</div>
							...
							<div className='w-[90%] h-[90%] flex flex-col justify-center'>
								<div className='w-full flex flex-col items-center'>
									...
									<input 
										...
										className='w-full min-w-[380px] max-w-[450px] radio text-[0.9rem] p-2 rounded-xl focus:outline-none bg-[#eeeeee] dark:bg-[#232323] border-2 border-[#dddddd] dark:border-[#232323] focus:border-blue-500 text-blue-600 dark:text-blue-400 italic'
									/>
								</div>

  ...
  return (
    <>
        <div key={index} className='flex flex-col rounded-xl ml-[10px] relative'>
            <div className='absolute -left-[10px] h-[1.5px] w-[10px] bg-[#cccccc] top-[40%]'/>
            ...
            style={{width : 'fit-content'}}>
                <div className='flex flex-row items-center gap-2 group'>
                    <div className='flex flex-row items-center bg-[#dddddd] py-2 rounded-2xl min-w-[190px]' style={{
                        ...
                        <div className='flex flex-col justify-center w-[calc(100%-70px)]'>
                            <Link className='text-[1rem] kanit hover:underline decoration-blue-500 duration-200 ease-in-out'>{reply.commentedUsername}</Link>
                            <div className='text-[0.85rem] radio pt-1 pr-4'><ReplyText text={reply.text} /></div>
                        </div>
                    </div>
                ...
                <div className='flex flex-row gap-10 justify-end mr-[50px] text-[0.75rem] radio'>
                    <div className={`${replyLiked ? 'text-blue-500' : 'text-[#232323]'} cursor-pointer`}
                        onClick={() => {
